...
namespace IBSampleApp
{
    partial class OrderDialog : Form
    {
        ...
        private void B_SaveOrder_Click(object sender, EventArgs e)
        {
            ...
            od.orderDefinitions.Add(new OrderDefinition());
            od.orderDefinitions[0].contract = GetOrderContract();
            od.orderDefinitions[0].order = GetOrder();

            od.saveXML(@"g:\temp\test.xml");
        }
    }
}
