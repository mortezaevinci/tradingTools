    ...
    partial class ConditionDialog : Form
    {
        ...
        public ConditionDialog(OrderCondition condition, IBClient ibClient)
        {
            ...
            switch (this.Condition.Type)
            {
                ...
                case OrderConditionType.Price:
                    fillFromCondition_rebuf(this.Condition as PriceCondition);
                     break;
        ...
        private void fillFromCondition(PriceCondition priceCondition)
        {
            ...
            priceMethod.SelectedItem = priceCondition.TriggerMethod.ToFriendlyString();
            priceMethod.SelectedIndex = (int)priceCondition.TriggerMethod;
         
            priceRb.Checked = true;
        }

        private void fillFromCondition_rebuf(PriceCondition priceCondition)
        {
            fillOperator(priceOperator, priceCondition);
        ...
        private void priceUnderlying_Click(object sender, EventArgs e)
        {
