...
namespace IBSampleApp.ui
{
    class ScannerManager : DataManager
    {
        ...
        {
            ibClient.ClientSocket.cancelScannerSubscription(currentreqid);
            DataGridView grid = (DataGridView)uiControl;
            grid.Rows.Clear();
            rowCounter = -1;
            currentreqid--;
        ...
        {
            ibClient.ClientSocket.reqScannerSubscription(currentreqid, scannerSubscription, null, filterOptions);
            currentreqid++;
        }
