...
namespace IBSampleApp
{
    partial class OrderDialog : Form
    {
        ...
        public async void SetOrder(Order order)
        {
            ...
            TB_ParentID.Text = order.ParentId.ToString();
        ...
        private void ContractSymbol_TextChanged(object sender, EventArgs e)
        {

        }

        private void B_SaveOrder_Click(object sender, EventArgs e)
        {
            ...
            od.orderWatchlists[watchlistindex].contractDefinitions[0].contract = GetOrderContract();
            od.orderWatchlists[watchlistindex].orderDefinitions[0].order = GetOrder();
