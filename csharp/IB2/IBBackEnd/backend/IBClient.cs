...
namespace IBApi
{
    public class IBClient : EWrapper
    {
        ...
        void EWrapper.historicalTicks(int reqId, HistoricalTick[] ticks, bool done)
        {
            ...
            if (historicalTickEnd != null)
            {
                sc.Post((t) => historicalTickEnd(reqId), null);
            }
        }
        ...
        void EWrapper.historicalTicksLast(int reqId, HistoricalTickLast[] ticks, bool done)
        {
            ...
            if (historicalTicksLast != null)
            {
                sc.Post((t) => historicalTicksLast(new HistoricalTicksLastMessage(reqId, ticks)), null);
            }
        }
