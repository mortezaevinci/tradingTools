...
from ibapi import connection as ibConnection
from ibapi import message as ib_message_type
...
class HFTModel:
    ...
    def __register_data_handlers(self,
        ...
        self.ib.registerAll(universal_event_handler)
        self.ib.unregister(universal_event_handler,
        ...
        self.ib.register(tick_event_handler,
                           ib_message_type.tickPrice,
                           ib_message_type.tickSize)
    ...
    def __send_order(self, symbol, qty):
        ...
        self.ib.placeOrder(self.__generate_order_id(),
                             stock_data.contract,
                             order)
    ...
    def start(self, symbols, trade_qty):
        ...
        self.connect_to_ib()  # Get IB connection object
