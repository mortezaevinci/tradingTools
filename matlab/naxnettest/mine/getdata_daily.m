...
for i=1:numel(symbols)
    symbols{i}
   [td,jd,~,~]=getMarketDataViaYahooChart(symbols{i}, '1mo', '1d',rq,c); 
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbols{i}) ' daily ' datestr(datetime(),"yyyy-mm-dd") '.mat'];
   save(name,'td','jd');
end