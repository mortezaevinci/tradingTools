...
calculations.levels.style=[style_svepivots  style_svepivots  style_wpivots  style_wpivots  style_orb  style_dailyHighLow  style_rlvls];
...
calculations.levels.id=[id_dsve id_msve id_dwpivots id_mwpivots id_orb id_dailyHighLow id_rlvls];
