...
function [rq,c] =getdata_func(looperParams,params,rq,c,updateRealtime,redo)
...
alreadydone=0;
    if (~updateRealtime & ~isempty(SYMBOLDONETODAY))
      if (strcmp(looperParams.date,'today'))
...
%     end
   ...
   save(name,'td','jd');
     ...
     try
          ...
          name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbol) ' monthly ' looperParams.date '.mat'];
