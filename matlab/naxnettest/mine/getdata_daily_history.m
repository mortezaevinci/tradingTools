...
[t,j,rq,c]=getMarketDataViaYahooChart('AAPL', '1mo', '1d');

for i=1:numel(symbols)
    symbols{i}
   [td,jd,~,~]=getMarketDataViaYahooChart(symbols{i}, '10y', '1d',rq,c); 
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbols{i}) ' daily_history ' datestr(datetime(),"yyyy-mm-dd") '.mat'];
   save(name,'td','jd');
end