function calculations=strategy_breakout_t2(params,commonticks)
...
id_msve=[0x0300 0x0301 0x0302 0x0303 0x0304 0x0305 0x0306 0x0307];
id_dsve=[0x0400 0x0401 0x0402 0x0403 0x0404 0x0405 0x0406 0x0407];
...
id_mwpivots=[0x0500 0x0501 0x0502 0x0503 0x0504 0x0505 0x0506 0x0507];
id_dwpivots=[0x0600 0x0601 0x0602 0x0603 0x0604 0x0605 0x0606 0x0607];
...
calculations.levels.values=[dsvepivots msvepivots dwpivots mwpivots orb dailyHighLow rlvls smas];
calculations.levels.color=[colors_svepivots colors_svepivots colors_wpivots colors_wpivots colors_orb colors_dailyHighLow colors_rlvls colors_smas];
calculations.levels.style=[style_svepivots  style_svepivots  style_wpivots  style_wpivots  style_orb  style_dailyHighLow  style_rlvls style_smas];
calculations.levels.direction=[dir_svepivots dir_svepivots dir_wpivots dir_wpivots dir_orb dir_dailyHighLow dir_rlvls dir_smas];
calculations.levels.width=[width_dsve width_msve width_dwpivots width_mwpivots width_orb width_dailyHighLow width_rlvls width_smas];
calculations.levels.power=[power_dsve power_msve power_dwpivots power_mwpivots power_orb power_dailyHighLow power_rlvls power_smas];
calculations.levels.id=[id_dsve id_msve id_dwpivots id_mwpivots id_orb id_dailyHighLow id_rlvls id_smas];
...
try
    %%;tic;
calculations.dsma5=(calculations.indicators{1}.upper.SMA5-[calculations.indicators{1}.upper.SMA5(1);calculations.indicators{1}.upper.SMA5(1);calculations.indicators{1}.upper.SMA5(1);calculations.indicators{1}.upper.SMA5(1);calculations.indicators{1}.upper.SMA5(1);calculations.indicators{1}.upper.SMA5(1:end-5)])*100./params.TimeTables.Minute.Close;
calculations.ddsma5=calculations.dsma5-[calculations.dsma5(1);calculations.dsma5(1:end-1)];
    
absolutevolumethresh=median(params.TimeTables.Day.Volume(end-5:end))/390;
