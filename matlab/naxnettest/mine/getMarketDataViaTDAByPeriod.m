...
jct.datetime = datetime(jct.datetime/1000, 'convertfrom', 'posixtime', 'Format', 'MM/dd/yy HH:mm:ss.SSS')-hours(4);

%setfirstmarkettime
dm=datetime([datestr(jct.datetime(1),'yyyy-mm-dd') ' 09:30:00']);
