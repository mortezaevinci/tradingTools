...
[t,j,rq,c]=getMarketDataViaYahooChart('AAPL', '5m', '1m');

for i=1:numel(symbols)
    symbols{i}
   [tm5,jm5,~,~]=getMarketDataViaYahooChart(symbols{i}, '5m', '1m',rq,c); 
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbols{i}) ' realtime.mat'];
   save(name,'tm5','jm5');
end