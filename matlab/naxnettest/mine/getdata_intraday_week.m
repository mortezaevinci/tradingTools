...
for i=1:numel(symbols)
    symbols{i}
   [tm,jm,~,~]=getMarketDataViaYahooChart(symbols{i}, '5d', '1m',rq,c); 
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbols{i}) ' minute 5d ' datestr(datetime(),"yyyy-mm-dd") '.mat'];
   save(name,'tm','jm');
end