...
%     end
   ...
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbol) ' 10minute today.mat'];
   save(name,'tm10','jm10');
    end
   ...
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbol) ' minute today.mat'];
   save(name,'tm','jm');
    end
        catch 
   ...
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbol) ' minute 5d today.mat'];
   save(name,'tdw','jdw');
    end
     catch
   ...
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbol) ' daily 5d today.mat'];
   save(name,'tw','jw');
    end
     catch
   ...
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbol) ' daily 1y today.mat'];
   save(name,'td','jd');
    end
     catch
   ...
   name=['Z:\My files\Project trading\traderdata\data\' filefriendlysymbol(symbol) ' monthly today.mat'];
   save(name,'tmo','jmo');
   end
    catch
