function n=graphStrategy_full_t7(layout,looperParams,params,calculations,result)
try
if (~isempty(layout))
...
if (~isempty(params.lower_indicators{axi}))
%nind=numel(params.lower_indicators{axi});
hold off
%for indi=1:nind
