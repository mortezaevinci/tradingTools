function [data,jdata,requestObj,crumb] = getMarketDataViaYahooChart(symbol, range, interval,requestObjIn,crumbin)
...
try
    ...
    dt=datestr(datetime(jdcr.timestamp, 'ConvertFrom', 'posixtime')+hours(gmtoffsethours));
