function getdata_daily5y_TDA_func(basedir,contracts,date0)

getdata_dailyset_TDA_func(basedir,contracts,date0,2000,'5y')
% 
...
%     
%    try
%         name=[basedir filefriendlysymbol(contracts{i}.FileSymbol) '\' filefriendlysymbol(contracts{i}.FileSymbol) ' daily 5y ' date0 '.mat'];
%         
