...
function [rq,c] =getdata_yahoo_func(looperEngine,params,rq,c,updateRealtime,redo)
version='yahoo';
...
symbol=params.contract.Symbol;
 failed=0;
directory_=[looperEngine.directories.data filefriendlysymbol(params.contract.FileSymbol) '\'];
if (~exist(directory_))
    mkdir(directory_);
end
