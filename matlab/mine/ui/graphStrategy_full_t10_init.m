...
plotcount=1;
for j=1:50
 layout.plocalOptimaProfile{plotcount}=plot(datetime(),0,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
...
plotcount=1;
for i=1:150
 layout.plevels{plotcount}=plot(datetime(),0,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');%plot([params.TimeTables.Minute.Date(genericrange(1)), params.TimeTables.Minute.Date(end)],[calculations.levels.values(i),calculations.levels.values(i)],calculations.levels.color{i},'linewidth',calculations.levels.width(i));
plotcount=plotcount+1;
end
...
for j=1:50
layout.plocalOptimaTrend{plotcount}= plot(datetime(),0,'LineStyle',':','Color',[0 0.75 1 1],'XLimInclude','off','YLimInclude','off');% plot(params.TimeTables.Minute.Date(onlyvals),vsample(onlyvals),'c:','linewidth',j);
    plotcount=plotcount+1;
end
...
for i=1:20
   layout.pindicators{plotcount}=plot(datetime(),0,'linestyle','--','color','k','linewidth',1,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
    plotcount=plotcount+1;
end
%% entries
plotcount=1;
layout.pmain{plotcount}=plot(datetime(),0,'m^','linewidth',2,'MarkerSize',3,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
plotcount=plotcount+1;
layout.pmain{plotcount}=plot(datetime(),0,'mv','linewidth',2,'MarkerSize',3,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
plotcount=plotcount+1;

%% exits
plotcount=1;
layout.pexits{plotcount}=plot(datetime(),0,'ks','linewidth',2,'MarkerSize',3,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
plotcount=plotcount+1;
layout.pexits{plotcount}=plot(datetime(),0,'ks','linewidth',2,'MarkerSize',3,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
plotcount=plotcount+1;
...
%% net entries
plotcount=1;
layout.pnet{plotcount}=plot(datetime(),0,'Marker','^','LineStyle','none','Color',[0 0.75 1 1],'linewidth',2,'MarkerSize',3,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
plotcount=plotcount+1;
layout.pnet{plotcount}=plot(datetime(),0,'Marker','v','LineStyle','none','Color',[0 0.75 1 1],'linewidth',2,'MarkerSize',3,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
plotcount=plotcount+1;


%% book levels
plotcount=1;
layout.pbooklvls{plotcount}=plot(datetime(),0,'LineStyle','--','Color',[1 0 1 1],'linewidth',1,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
plotcount=plotcount+1;
layout.pbooklvls{plotcount}=plot(datetime(),0,'LineStyle','--','Color',[1 0 1 1],'linewidth',1,'ButtonDownFcn',@generalPlotCallback,'XLimInclude','off','YLimInclude','off');
plotcount=plotcount+1;
...
plotcount=1;
layout.pprofiles{plotcount}=plot(datetime(),0,'linestyle','--','color','b','linewidth',1,'XLimInclude','off','YLimInclude','off');
plotcount=plotcount+1;
...
for i=1:2
layout.candleplotformat.bar_low.handle(i).DisplayName=num2str(params.si);
layout.candleplotformat.bar_high.handle(i).DisplayName=num2str(params.si);
end
...
if (false)%~isempty(indicatorindex))
    ...
    layout.lowerx{axi}=plot([[datetime();datetime()],[datetime();datetime()],[datetime();datetime()]],[[0;0],[0;0],[0;0]],'XLimInclude','off','YLimInclude','off');
...
grid on;
hold off;
optimizeAxes(layout.axlower{axi+1});
