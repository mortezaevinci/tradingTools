...
plotformat.bar_low.handle(2).CData = [0.8 0 0];
plotformat.bar_low.handle(2).LineWidth=1;
plotformat.bar_low.handle(2).EdgeColor=[.5 0 0];
...
%ba(1).CData = [0.3 0.3 0.7];
plotformat.bar_high.handle(2).CData = [0 0.8 0];
plotformat.bar_high.handle(2).LineWidth=1;
plotformat.bar_high.handle(2).EdgeColor=[0 0.5 0];
