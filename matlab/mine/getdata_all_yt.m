...
try
   ...
   % date0=[num2str(year_) '-' num2str(j,'%02.f') '-' num2str(i,'%02.f')];
    ...
    contracts_yahoo;
    contracts={genContract([],'AAL')};
    getdata_intraday_yahoo_func(basedir,contracts,date1,date2);
    getdata_dailyset_yahoo_func(basedir,contracts,date0,500,'1y');
    getdata_dailyset_yahoo_func(basedir,contracts,date0,2000,'5y');
    
    %%contracts_yahoo_common;
    %%fix_yahoo_intraday_bytda_func(basedir,contracts,date1,date2);
