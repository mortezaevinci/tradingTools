...
c_daystoexpire=(chamm{i}.DaysToExp+weekday0-1)<maxdaystoexpiry; %will give weeklies
...
maxnote=max(chamm{i}(symbolind,:).Trade__nbsp_Notional)/500;

ui=1;s='o';cl=[0 1 0];scatter(datetimes{i}(useind{ui}),chamm{i}(useind{ui},:).Strike,(chamm{i}.Trade__nbsp_Notional(useind{ui})/maxnote),s,'MarkerEdgeColor',cl);
ui=2;s='d';cl=[0 1 0];scatter(datetimes{i}(useind{ui}),chamm{i}(useind{ui},:).Strike,(chamm{i}.Trade__nbsp_Notional(useind{ui})/maxnote),s,'MarkerEdgeColor',cl);
ui=3;s='o';cl=[1 0 0];scatter(datetimes{i}(useind{ui}),chamm{i}(useind{ui},:).Strike,(chamm{i}.Trade__nbsp_Notional(useind{ui})/maxnote),s,'MarkerEdgeColor',cl);
ui=4;s='d';cl=[1 0 0];scatter(datetimes{i}(useind{ui}),chamm{i}(useind{ui},:).Strike,(chamm{i}.Trade__nbsp_Notional(useind{ui})/maxnote),s,'MarkerEdgeColor',cl);
ui=5;s='d';cl=[0.8 0 0.8];scatter(datetimes{i}(useind{ui}),chamm{i}(useind{ui},:).Strike,(chamm{i}.Trade__nbsp_Notional(useind{ui})/maxnote),s,'MarkerEdgeColor',cl);
ui=6;s='o';cl=[0 0.7 0.7];scatter(datetimes{i}(useind{ui}),chamm{i}(useind{ui},:).Strike,(chamm{i}.Trade__nbsp_Notional(useind{ui})/maxnote),s,'MarkerEdgeColor',cl);
