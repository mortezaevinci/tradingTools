...
commonticks{cindex}.params.net.lower_indicators.inputs={'VolumeBuzzRatio','SellVolumeBuzzRatio','BuyVolumeBuzzRatio',...
    'relativeQuote','relativeQuote10','relativeQuote50',...
    'dcs_close10','dcs_total10','dcs_close','dcs_total'};
...
commonticks{cindex}.params.net.lower_indicators.inputs={'relativeQuote','relativeQuote10','relativeQuote21','relativeQuote50'};
