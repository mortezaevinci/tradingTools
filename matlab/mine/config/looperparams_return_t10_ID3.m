...
genContract([],'DIS'),...
genContract([],'BILI'),...
genContract([],'SPOT'),...genContract([],'GILD'),...genContract([],'NET'),...genContract([],'UAL'),...
genContract([],'ROKU'),...
genContract([],'BAC'),...
genContract([],'INO'),...
genContract([],'DAL'),...
...
basedate='2020-06-30';%the use of this is now extended, this is now the day, data are analyzed, this could be 'today' for 'today'
