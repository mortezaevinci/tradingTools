...
%looperEngine.symbols={'AAPL','AAL','AMD','AMZN','BAC','BA','TSLA','GE','WMT','SHOP','MSFT','NVDA','NFLX','DIS','FB'};
...
looperEngine.net.hiddenLayerSize=3200;
...
looperEngine.net.trainParam.Sigma=1e-10; %
