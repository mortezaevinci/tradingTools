...
%looperEngine.symbols={'AAPL','AAL','AMD','AMZN','BAC','BA','TSLA','GE','WMT','SHOP','MSFT','NVDA','NFLX','DIS','FB','SPY'};
...
looperEngine.net.trainParam.goal = 1e-7;
looperEngine.net.trainParam.min_grad = 1e-9;
