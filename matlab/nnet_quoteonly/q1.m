...
attmx=attm(1:end-predictmanysamples,targetindex);
mx=tonndata(attmx,false,false);

attm=attm(1:end-predictmanysamples,:);
...
xsm=cell2mat(xs);
ysm=cell2mat(ys);
samplesizediff=inputDelays(end);%+predictmanysamples;% numel(T)-size(ysm,2)+1;
Tm=cell2mat(T);
for i=1:size(ysm,1)
figure

plot((1:numel(ysm(i,:)))+samplesizediff,ysm(i,:),'r');
hold on;
plot(1:numel(T),Tm(i,:),'b');
...
plot((1:numel(ysm(i,:)))+samplesizediff,ysm(i,:),'b');
hold on;
plot(1:numel(attm(:,2)'),attm(:,2)','g');
plot(1:numel(attm(:,2)'),attm(:,3)','r');
end

samplesizediff=inputDelays(end)-1;
...
% ysm=cell2mat(y);
% samplesizediff=numel(T)-size(ysm,2);
% 
% for i=1:size(ysm,1)
% figure
% 
% plot((1:size(ysm,2))+samplesizediff,ysm(i,:),'r');
% hold on;
% plot(1:numel(T),Tm(i,:),'b');
% end
% 
