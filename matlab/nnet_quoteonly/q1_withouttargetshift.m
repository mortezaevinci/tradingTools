...
%I think, in this indexing
%1) prediction points are matched
%2) the prediction points are available 1 time step sooner (Being the whole
%purpose of prediction)
samplesizediff=max(inputDelays(end),feedbackDelays(end)); % this -1 to show availability of prediction
