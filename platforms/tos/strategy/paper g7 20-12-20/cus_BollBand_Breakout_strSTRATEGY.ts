...
def closeMA = close(symbol = market) < RF;
...
AddOrder(condition = buySignal, tradeSize=1,type = OrderType.BUY_TO_OPEN, price = open, name = "bbBreak_LE");
AddOrder(condition = bbBreakDown, tradeSize=1,type = OrderType.SELL_TO_CLOSE, price = open, name = "bbBreak_LX");
AddOrder(condition = cross, type = OrderType.SELL_TO_CLOSE, price = open, name = "TrailStop",tradeSize=1);
