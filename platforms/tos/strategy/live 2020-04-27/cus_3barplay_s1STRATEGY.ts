...
and (high[4] - close[ibar1]) < 0
and (high[5] - close[ibar1]) < 0
and (high[6] - close[ibar1]) < 0
and (high[7] - close[ibar1]) < 0
and (high[8] - close[ibar1]) < 0
and (high[9] - close[ibar1]) < 0
and (high[10] - close[ibar1]) < 0;
...
def enter = ( bar1 + 2 * bar2 + 4 * bar3);

input tradeSize = 1;

AddOrder(OrderType.BUY_TO_OPEN, enter >= 7, open[-1], tradeSize, Color.GREEN, Color.GREEN);

AddOrder(OrderType.SELL_TO_CLOSE, enter >= 7, open[-3], tradeSize, Color.RED, Color.RED);