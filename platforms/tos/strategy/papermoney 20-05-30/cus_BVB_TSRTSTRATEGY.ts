...
def score = reference TechnicalStockRating("vfi length" = vfiLength, "average length" = averageLength, "trend quality length" = trendQualityLength, "max stiffness" = maxStiffness, "market index" = marketIndex, "weight for money flow" = weightForMoneyFlow, "weight for trading above average" = weightForTradingAboveAverage, "weight for uptrend" = weightForUptrend, "weight for trend quality" = weightForTrendQuality, "weight for market direction" = weightForMarketDirection);
