...
def UpAlert =!IsNaN(UpSignal) and close>SMA and close>dailysma()."DailySMA";
def DownAlert = !IsNaN(DownSignal);

AddOrder(OrderType.BUY_TO_OPEN, UpAlert, open[-1], tradeSize, Color.GREEN, Color.GREEN);

AddOrder(OrderType.SELL_TO_CLOSE, DownAlert, open[-1], tradeSize, Color.RED, Color.RED);
