...
def diffVolume =absvalue(Volume * (close*2 - low- high) / (high - low));

    def prevVol = (diffVolume + diffVolume[1])/2; #/2 for ordinary volume
...
def pivotmoved=errorpercent*pivot;
  ...
  def comp2= if (dir == CrossingDirection.ABOVE) then(open[1]<pivotmoved) else (open[1]>pivotmoved);

    plot crosshappened =  (pivotmoved < compfull2 and pivotmoved > compfull1) and comp2;
...
if (dfindend3 > 0 or doOnlyRealtime == 0)
{
    ...
    if (1)#goodvolume > goodvolumethresh )
    {
        ...
        if (1)#haspp and rsiup and dvi<=-dvithresh)
        {

            upd_ = crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, s3)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, s2)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, s1)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, pp)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, r1)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, r2)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, r3)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, rd1)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, ru1)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, rd2)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, ru2)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, dh)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime, dl)."crosshappened" ;#or
                   # crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime,hVA)."crosshappened" or
                   # crosspivot(crossoverlength, PilotsAggd, CrossingDirection.ABOVE,  BarsAggd, pivoterromargin, doOnlyRealtime,lVA)."crosshappened";
            ...
            udirectionwithprev = (close > open) and close > open[1] and close > open[2];
        ...
        if (1)#hasfp and rsidn and dvi>=dvithresh)
        {
            dnd_ =  crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, s3)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, s2)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, s1)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, pp)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, r1)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, r2)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, r3)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, rd1)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, ru1)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, rd2)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, ru2)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, dh)."crosshappened" or
                    crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime, dl)."crosshappened" ;# or
                   # crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime,hVA)."crosshappened";# or
                  #  crosspivot(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin, doOnlyRealtime,lVA)."crosshappened"

            dnd = dnd_;#selectcross(dnd_, 1);
            ddpn = 0;#crosspivots(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin)."pivotnext";
            ddpc = 0;#crosspivots(crossoverlength, PilotsAggd, CrossingDirection.BELOW,  BarsAggd, pivoterromargin)."pivotbreak";
            dmonthlywithinnot = 1;# - monthlywithin(ddpc, ddpn);
            ddirectionwithprev = (close < open) and close < open[1] and close<open[2];
...
input tradesize = 1;
#AddOrder(OrderType.sell_to_close, pbuyd  and marketTime, open[-1], tradesize, Color.GREEN, Color.GREEN,"bto@"+open[-1]);
#AddOrder(OrderType.buy_to_close, pselld and marketTime, open[-1], tradesize, Color.RED, Color.RED,"sto@"+open[-1]);

#AddOrder(OrderType.BUY_TO_OPEN, pbuyd  and marketTime, open[-1], tradesize, Color.GREEN,Color.GREEN,"bto@"+open[-1]+","+goodvolume+","+rsi(length=9)."rsi"+","+dvi+","+haspp+","+hasfp+","+relativestrength());
#AddOrder(OrderType.SELL_TO_OPEN, pselld and marketTime, open[-1], tradesize, Color.RED, Color.RED,"sto@"+open[-1]+","+goodvolume+","+rsi(length=9)."rsi"+","+dvi+","+haspp+","+hasfp+","+relativestrength());
