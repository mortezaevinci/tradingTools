...
input tradesize=1;
AddOrder(OrderType.sell_to_close, pdn , open, tradesize, Color.red, Color.red,"stc@"+open);
AddOrder(OrderType.buy_to_close, pup , open, tradesize, Color.GREEN, Color.GREEN,"btc@"+open);

AddOrder(OrderType.sell_to_open, pdn , open, tradesize, Color.red, Color.red,"sto@"+open);
AddOrder(OrderType.buy_to_open, pup , open, tradesize, Color.GREEN, Color.GREEN,"bto@"+open);
