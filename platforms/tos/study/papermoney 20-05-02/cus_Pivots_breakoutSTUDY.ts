...
plot crossauto=if (momentumvalid) then (upcrossd>1 and upcrossd<7) else upcrossd;
...
def Momentumpositive=Momentum_m>0 and Momentum_d>0;
...
plot pupm=marketTime and selectcross(upw,momentum>0);
...
plot pdnm=marketTime and selectcross(dnw,momentum==0);
